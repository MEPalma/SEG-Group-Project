...
public class JunitTestCases {
    ...
    @Test
    public void impressionLogQueryTest() {
    ...
    @Test
    public void impressionLogUserIdQueryTest() {
    ...
    @Test
    public void serverLogQueryTest() {
    ...
    @Test
    public void serverLogUserIDTest() {
    ...
    //////////////////////////////////////////////////////////////////Constrains regarding the foreign keys>
//    @Test
//    public void addClickEntryContains() {
...
//    @Test
//
//    public void addImpressionEntryContains() {
...
//    }
//    @Test
//    public void addServerEntryContains() {
...
//    }
    ...
    @Test
    public void numberOfImpressionsWeekQueryTest() {
        ...
        String expImpWeek = "select Date as d,count(userId) as c from impression_logs  inner join Users on userid=Users.id WHERE d > ''  AND d < ''  AND Gender = 'Male'  AND Age = 'Age_25_34'  AND Income = 'Medium'  group by strftime('%W', d);";
        String resImpWeek = QueryComposer.composeQuery(graphSImpWeek);
    ...
    @Test
    public void numberOfImpressionsDayQueryTest() {
        ...
        String expImpDay = "select Date as d,count(userId) as c from impression_logs inner join Users on userid=Users.id WHERE d > '' AND d < '' AND Gender ='Male' AND Age = 'Age_25_34' AND Income = 'Medium' group by strftime('%d', d);".replaceAll("\\s+", "");
        ;
        String resImpDay = QueryComposer.composeQuery(graphSImpDay).replaceAll("\\s+", "");
        ;
    ...
    @Test
    public void numberOfImpressionsHourQueryTest() {
        ...
        String expImpWeek = "select Date as d,count(userId) as c from impression_logs  inner join Users on userid=Users.id WHERE d > ''  AND d < ''  AND Gender = 'Male'  AND Age = 'Age_25_34'  AND Income = 'Medium'  group by strftime('%H:%d', d);".replaceAll("\\s+", "");;
        String resImpWeek = QueryComposer.composeQuery(graphSImpWeek).replaceAll("\\s+", "");
    ...
    @Test
    public void numberOfClicksWeekQueryTest() {
        ...
        String expClickWeek = "select click_logs.Date as d,count(ClickCost) as c from click_logs inner join Users on click_logs.userid=Users.id  inner join impression_logs on click_logs.userid=impression_logs.userid  WHERE d > ''  AND d < ''  AND Gender = 'Female'  AND Age = 'Age_35_44'  AND Income = 'Low'  group by strftime('%W', d);".replaceAll("\\s+", "");
        String resClickWeek = QueryComposer.composeQuery(graphSClickWeek).replaceAll("\\s+", "");
    ...
    @Test
    public void numberOfClicksDayQueryTest() {
        //Test for Number of Clicks per day
        FilterSpecs filterSClickDay = new FilterSpecs();
        filterSClickDay.getAges().add(UserEntry.Age.Age_35_44);
        ...
        String expClickDay = "select click_logs.Date as d,count(ClickCost) as c from click_logs inner join Users on click_logs.userid=Users.id  inner join impression_logs on click_logs.userid=impression_logs.userid  WHERE d > ''  AND d < ''  AND Gender = 'Male'  AND Age = 'Age_35_44'  AND Income = 'High'  group by strftime('%d', d);";
        String resClickDay = QueryComposer.composeQuery(graphSClickDay);
    ...
    @Test
    public void numberOfClicksHourQueryTest() {
        ...
        String expClicksHour = "select click_logs.Date as d,count(ClickCost) as c from click_logs inner join Users on click_logs.userid=Users.id  inner join impression_logs on click_logs.userid=impression_logs.userid  WHERE d > ''  AND d < ''  AND Gender = 'Female'  AND Age = 'Age_less_than_25'  AND Income = 'Low'  group by strftime('%H:%d', d);";
        String resClicksHour = QueryComposer.composeQuery(graphSClicksHour);
    ...
    public void numberOfUniquesWeekQueryTest() {
        ...
        String expUniquesWeek = "select click_logs.Date as d,count(distinct  click_logs.userid) as c from click_logs inner join Users on click_logs.userid=Users.id  inner join impression_logs on click_logs.userid=impression_logs.userid  WHERE d > ''  AND d < ''  AND Gender = 'Female'  AND Age = 'Age_less_than_25'  AND Income = 'Low'  group by strftime('%W', d);";
        String resUniquesWeek = QueryComposer.composeQuery(graphSUniquesWeek);
    ...
    @Test
    public void numberOfUniquesDayQueryTest() {
        ...
        String expUniquesDay = "select click_logs.Date as d,count(distinct  click_logs.userid) as c from click_logs WHERE d > ''  AND d < ''  group by strftime('%d', d);".replaceAll("\\s+", "");
        String resUniquesDay = QueryComposer.composeQuery(graphSUniquesDay).replaceAll("\\s+", "");
    ...
    @Test
    public void numberOfUniquesHourQueryTest() {
        ...
        String expUniquesHour = "select click_logs.Date as d,count(distinct  click_logs.userid) as c from click_logs WHERE d > ''       AND d < ''  group by strftime('%H:%d', d);".replaceAll("\\s+", "");
        String resUniquesHour = QueryComposer.composeQuery(graphSUniquesHour).replaceAll("\\s+", "");
        ;
    ...
    public void numberOfBouncesPagesViewedWeekQueryTest() {
        ...
        String expBouncesWeek = "select server_logs.EntryDate as d, count(server_logs.id) as c from server_logs  WHERE d > ''  AND d < ''  And PagesViewed<=1  group by strftime('%W', d);".replaceAll("\\s+", "");
        String resBouncesWeek = QueryComposer.composeQuery(graphSBouncesWeek).replaceAll("\\s+", "");
    ...
    @Test
    public void numberOfBouncesPagesViewedQueryTest() {
        ...
        //TODO
        String expBouncesDay = "select server_logs.EntryDate as d, count(server_logs.id) as c from server_logs  WHERE d > ''  AND d < ''  And PagesViewed<=1  group by strftime('%d', d);";
        String resBouncesDay = QueryComposer.composeQuery(graphSBouncesDay);
    ...
    @Test
    public void numberOfBouncesPagesViewedHourQueryTest() {
        ...
        String expBouncesHour = "select server_logs.EntryDate as d, count(server_logs.id) as c from server_logs  WHERE d > ''  AND d < ''  And PagesViewed<=1  group by strftime('%H:%d', d);".replaceAll("\\s+", "");
        String resBouncesHour = QueryComposer.composeQuery(graphSBouncesHour).replaceAll("\\s+", "");
    ...
    @Test
    public void numberOfConversionsWeekQueryTest() {
        ...
        String expConversionsWeek = "select server_logs.EntryDate as d, count(Conversion) as c from server_logs  WHERE d > ''  AND d < ''  And Conversion='Yes'  group by strftime('%W', d);".replaceAll("\\s+", "");
        String resConversionsWeek = QueryComposer.composeQuery(graphSConversionsWeek).replaceAll("\\s+", "");
    ...
    @Test
    public void numberOfConversionsDayQueryTest() {
        ...
        String expConversionsDay = "select server_logs.EntryDate as d, count(Conversion) as c from server_logs  WHERE d > ''  AND d < ''  And Conversion='Yes'  group by strftime('%d', d);".replaceAll("\\s+", "");
        String resConversionsDay = QueryComposer.composeQuery(graphSConversionsDay).replaceAll("\\s+", "");
    ...
    @Test
    public void numberOfConversionsHourQueryTest() {
        ...
        String expConversionsHour = "select server_logs.EntryDate as d, count(Conversion) as c from server_logs  WHERE d > ''  AND d < ''  And Conversion='Yes'  group by strftime('%H:%d', d);".replaceAll("\\s+", "");
        String resConversionsHour = QueryComposer.composeQuery(graphSConversionsHour).replaceAll("\\s+", "");
    ...
    public void totalCostWeekQueryTest() {
        ...
        String expTotalCostWeek = "select click_logs.date as d,sum(ClickCost) as c from click_logs  WHERE d > ''  AND d < ''  group by strftime('%W', d);".replaceAll("\\s+", "") +
                "select Date as d,sum(impressionCost) as c from impression_logs  WHERE d > ''  AND d < ''  group by strftime('%W', d);".replaceAll("\\s+", "");
        String resTotalCostWeek = QueryComposer.composeSum(graphSTotalCostWeek).get(0).replaceAll("\\s+", "")+QueryComposer.composeSum(graphSTotalCostWeek).get(1).replaceAll("\\s+", "");
    ...
    @Test
    public void totalCostDayQueryTest() {
        ...
        String expTotalCostDay = "select click_logs.date as d,sum(ClickCost) as c from click_logs  WHERE d > ''  AND d < ''  group by strftime('%d', d);".replaceAll("\\s+", "") +
                "select Date as d,sum(impressionCost) as c from impression_logs  WHERE d > ''  AND d < ''  group by strftime('%d', d);".replaceAll("\\s+", "");
        String resTotalCostDay = QueryComposer.composeSum(graphSTotalCostDay).get(0).replaceAll("\\s+", "")+QueryComposer.composeSum(graphSTotalCostDay).get(1).replaceAll("\\s+", "");
    ...
    @Test
    public void totalCostHourQueryTest() {
        ...
        String expTotalCostHour = "select click_logs.date as d,sum(ClickCost) as c from click_logs  WHERE d > ''  AND d < ''  group by strftime('%H:%d', d);".replaceAll("\\s+", "") +
                "select Date as d,sum(impressionCost) as c from impression_logs  WHERE d > ''  AND d < ''  group by strftime('%H:%d', d);".replaceAll("\\s+", "");
        String resTotalCostHour = QueryComposer.composeSum(graphSTotalCostHour).get(0).replaceAll("\\s+", "")+""+QueryComposer.composeSum(graphSTotalCostHour).get(1).replaceAll("\\s+", "");
    ...
    //TESTS FOR CTR--TOTALLY WRONG!!!!!
    @Test
    public void ctrWeekQueryTest() {
        ...
        String expCTRWeek = "select click_logs.date as d,sum(ClickCost) as c from click_logs WHERE d > ''  AND d < ''  group by strftime('%W', d);".replaceAll("\\s+", "") +
                "select Date as d,sum(impressionCost) as c from impression_logs  WHERE d > ''  AND d < ''  group by strftime('%W', d);".replaceAll("\\s+", "");
        String resCTRWeek = QueryComposer.composeSum(graphSCTRWeek).get(0).replaceAll("\\s+", "")+""+QueryComposer.composeSum(graphSCTRWeek).get(1).replaceAll("\\s+", "");
    ...
    public void ctrDayQueryTest() {
        ...
        String expCTRDay = "select click_logs.date as d,sum(ClickCost) as c from click_logs  WHERE d > ''  AND d < ''  group by strftime('%d', d);".replaceAll("\\s+", "") +
                "select Date as d,sum(impressionCost) as c from impression_logs   WHERE d > ''  AND d < ''  group by strftime('%d', d);".replaceAll("\\s+", "");
        String resCTRDay =QueryComposer.composeSum(graphSCTRDay).get(0).replaceAll("\\s+", "")+""+QueryComposer.composeSum(graphSCTRDay).get(1).replaceAll("\\s+", "");
    ...
    public void ctrHourQueryTest() {
        ...
        String expCTRHour = "select click_logs.date as d,sum(ClickCost) as c from click_logs  WHERE d > ''  AND d < ''  group by strftime('%H:%d', d);".replaceAll("\\s+", "") +
                "select Date as d,sum(impressionCost) as c from impression_logs    WHERE d > ''  AND d < ''  group by strftime('%H:%d', d);".replaceAll("\\s+", "") +
                "";
        String resCTRHour = QueryComposer.composeSum(graphSCTRHour).get(0).replaceAll("\\s+", "")+""+QueryComposer.composeSum(graphSCTRHour).get(1).replaceAll("\\s+", "");
    ...
    public void cpaWeekQueryTest() {
        ...
        String expCPAWeek = "select click_logs.date as d,sum(ClickCost) as c from click_logs  WHERE d > ''  AND d < ''  group by strftime('%W', d);" +
                "select Date as d,sum(impressionCost) as c from impression_logs  WHERE d > ''  AND d < ''  group by strftime('%W', d);" +
                "select server_logs.EntryDate as d, count(Conversion) as c from server_logs  WHERE d > ''  AND d < ''  And Conversion='Yes'  group by strftime('%W', d);";
        String resCPAWeek = QueryComposer.composeSum(graphSCPAWeek).get(0)+QueryComposer.composeSum(graphSCPAWeek).get(1)+QueryComposer.getNumberOfConversions(graphSCPAWeek);
    ...
    public void cpaDayQueryTest() {
        ...
        String expCPADay = "select click_logs.date as d,sum(ClickCost) as c from click_logs  WHERE d > ''  AND d < ''  group by strftime('%d', d);" +
                "select Date as d,sum(impressionCost) as c from impression_logs  WHERE d > ''  AND d < ''  group by strftime('%d', d);" +
                "select server_logs.EntryDate as d, count(Conversion) as c from server_logs  WHERE d > ''  AND d < ''  And Conversion='Yes'  group by strftime('%d', d);";
        String resCPADay = QueryComposer.composeSum(graphSCPADay).get(0)+QueryComposer.composeSum(graphSCPADay).get(1)+QueryComposer.getNumberOfConversions(graphSCPADay);
    ...
    public void cpaHourQueryTest() {
        ...
        String expCPAHour = "select click_logs.date as d,sum(ClickCost) as c from click_logs  WHERE d > ''  AND d < ''  group by strftime('%H:%d', d);" +
                "select Date as d,sum(impressionCost) as c from impression_logs  WHERE d > ''  AND d < ''  group by strftime('%H:%d', d);" +
                "select server_logs.EntryDate as d, count(Conversion) as c from server_logs  WHERE d > ''  AND d < ''  And Conversion='Yes'  group by strftime('%H:%d', d);";
        String resCPAHour = QueryComposer.composeSum(graphSCPAHour).get(0)+QueryComposer.composeSum(graphSCPAHour).get(1)+QueryComposer.getNumberOfConversions(graphSCPAHour);
    ...
    public void cpcWeekQueryTest() {
        ...
        String expCPCWeek = "select click_logs.date as d,sum(ClickCost) as c from click_logs  WHERE d > ''  AND d < ''  group by strftime('%W', d);" +
                "select Date as d,sum(impressionCost) as c from impression_logs  WHERE d > ''  AND d < ''  group by strftime('%W', d);" +
                "select click_logs.Date as d,count(ClickCost) as c from click_logs WHERE d > ''  AND d < ''  group by strftime('%W', d);";
        String resCPCWeek = QueryComposer.composeSum(graphSCPCWeek).get(0)+QueryComposer.composeSum(graphSCPCWeek).get(1)+QueryComposer.getNumberOfClicks(graphSCPCWeek);
    ...
    public void cpcDayQueryTest() {
        ...
        String expCPCDay = "select click_logs.date as d,sum(ClickCost) as c from click_logs  WHERE d > ''  AND d < ''  group by strftime('%d', d);" +
                "select Date as d,sum(impressionCost) as c from impression_logs  WHERE d > ''  AND d < ''  group by strftime('%d', d);" +
                "select click_logs.Date as d,count(ClickCost) as c from click_logs WHERE d > ''  AND d < ''  group by strftime('%d', d);" +
                "";
        String resCPCDay = QueryComposer.composeSum(graphSCPCDay).get(0)+QueryComposer.composeSum(graphSCPCDay).get(1)+QueryComposer.getNumberOfClicks(graphSCPCDay);
    ...
    public void cpcHourQueryTest() {
        ...
        String expCPCHour = "select click_logs.date as d,sum(ClickCost) as c from click_logs  WHERE d > ''  AND d < ''  group by strftime('%H:%d', d);" +
                "select Date as d,sum(impressionCost) as c from impression_logs  WHERE d > ''  AND d < ''  group by strftime('%H:%d', d);" +
                "select click_logs.Date as d,count(ClickCost) as c from click_logs WHERE d > ''  AND d < ''  group by strftime('%H:%d', d);";
        String resCPCHour = QueryComposer.composeSum(graphSCPCHour).get(0)+QueryComposer.composeSum(graphSCPCHour).get(1)+QueryComposer.getNumberOfClicks(graphSCPCHour);
    ...
    public void cpmWeekQueryTest() {
        ...
        String expCPMWeek = "select click_logs.date as d,sum(ClickCost) as c from click_logs  WHERE d > ''  AND d < ''  group by strftime('%W', d);" +
                "select Date as d,sum(impressionCost) as c from impression_logs  WHERE d > ''  AND d < ''  group by strftime('%W', d);" +
                "select Date as d,count(userId) as c from impression_logs  WHERE d > ''  AND d < ''  group by strftime('%W', d);" +
                "";
        String resCPMWeek = QueryComposer.composeSum(graphSCPMWeek).get(0)+QueryComposer.composeSum(graphSCPMWeek).get(1)+QueryComposer.getNumberOfImpressions(graphSCPMWeek);
    ...
    public void cpmDayQueryTest() {
        ...
        String expCPMDay = "select click_logs.date as d,sum(ClickCost) as c from click_logs  WHERE d > ''  AND d < ''  group by strftime('%d', d);" +
                "select Date as d,sum(impressionCost) as c from impression_logs  WHERE d > ''  AND d < ''  group by strftime('%d', d);" +
                "select Date as d,count(userId) as c from impression_logs  WHERE d > ''  AND d < ''  group by strftime('%d', d);";
        String resCPMDay = QueryComposer.composeSum(graphSCPMDay).get(0)+QueryComposer.composeSum(graphSCPMDay).get(1)+QueryComposer.getNumberOfImpressions(graphSCPMDay);
    ...
    public void cpmHourQueryTest() {
        ...
        String expCPMHour = "select click_logs.date as d,sum(ClickCost) as c from click_logs  WHERE d > ''  AND d < ''  group by strftime('%H:%d', d);" +
                "select Date as d,sum(impressionCost) as c from impression_logs  WHERE d > ''  AND d < ''  group by strftime('%H:%d', d);" +
                "select Date as d,count(userId) as c from impression_logs  WHERE d > ''  AND d < ''  group by strftime('%H:%d', d);";
        String resCPMHour = QueryComposer.composeSum(graphSCPMHour).get(0)+QueryComposer.composeSum(graphSCPMHour).get(1)+QueryComposer.getNumberOfImpressions(graphSCPMHour);
    ...
    public void bounceRateWeekQueryTest() {
        ...
        String expBounceRateWeek = "select server_logs.EntryDate as d, count(server_logs.id) as c from server_logs  WHERE d > ''  AND d < ''  And PagesViewed<=1  group by strftime('%W', d);".replaceAll("\\s+", "") +
                "select click_logs.Date as d,count(ClickCost) as c from click_logs WHERE d > ''  AND d < ''  group by strftime('%W', d);".replaceAll("\\s+", "");
        String resBounceRateWeek = QueryComposer.getNumberOfBounces(graphSBounceRateWeek).replaceAll("\\s+", "")+QueryComposer.getNumberOfClicks(graphSBounceRateWeek).replaceAll("\\s+", "");
    ...
    @Test
    public void bounceRateDayQueryTest() {
        ...
        String expBounceRateDay = "select server_logs.EntryDate as d, count(server_logs.id) as c from server_logs WHERE d > ''  AND d < ''  And PagesViewed<=1  group by strftime('%d', d);".replaceAll("\\s+", "") +
                "select click_logs.Date as d,count(ClickCost) as c from click_logs WHERE d > ''  AND d < ''  group by strftime('%d', d);".replaceAll("\\s+", "");
        String resBounceRateDay = QueryComposer.getNumberOfBounces(graphSBounceRateDay).replaceAll("\\s+", "")+QueryComposer.getNumberOfClicks(graphSBounceRateDay).replaceAll("\\s+", "");
    ...
    @Test
    public void bounceRateHourQueryTest() {
        ...
        String expBounceRateHour = "select server_logs.EntryDate as d, count(server_logs.id) as c from server_logs WHERE d > ''  AND d < ''  And PagesViewed<=1 group by strftime('%H:%d', d);".replaceAll("\\s+", "") +
                "select click_logs.Date as d,count(ClickCost) as c from click_logs WHERE d > ''  AND d < ''  group by strftime('%H:%d', d);".replaceAll("\\s+", "");
        String resBounceRateHour = QueryComposer.getNumberOfBounces(graphSBounceRateHour).replaceAll("\\s+", "")+QueryComposer.getNumberOfClicks(graphSBounceRateHour).replaceAll("\\s+", "");
